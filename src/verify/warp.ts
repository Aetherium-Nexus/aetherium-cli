...
import { buildArtifact } from "@aetherium-nexus/core/buildArtifact.js";
import {
  ChainMap,
...
import { Address, assert, objFilter } from "@aetherium-nexus/utils";
...
export async function runVerifyWarpRoute({
  ...
  for (const token of warpCoreConfig.tokens) {
    ...
    const contractName = aetERC20contracts[tokenType];
