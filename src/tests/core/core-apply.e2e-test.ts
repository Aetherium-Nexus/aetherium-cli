...
import { Address, Domain, addressToBytes32 } from "@aetherium-nexus/utils";
...
describe("aetherium core apply e2e tests", async function () {
  ...
  it("should update the mailbox owner", async () => {
    ...
    await aetheriumCoreApply(CHAIN_NAME_2, CORE_READ_CONFIG_PATH_2);
  ...
  it("should enroll a remote ICA Router and update the config on all involved chains", async () => {
    ...
    await aetheriumCoreApply(CHAIN_NAME_2, CORE_READ_CHAIN_2_CONFIG_PATH);
