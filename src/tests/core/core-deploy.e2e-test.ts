...
describe("aetherium core deploy e2e tests", async function () {
  ...
  describe("aetherium core deploy", () => {
    it("should create a core deployment with the signer as the mailbox owner", async () => {
      ...
      const output = aetheriumCoreDeployRaw(CORE_CONFIG_PATH).stdio("pipe");
  ...
  describe("aetherium core deploy --yes", () => {
    it("should fail if the --chain flag is not provided but the --yes flag is", async () => {
      ...
      const output = aetheriumCoreDeployRaw(CORE_CONFIG_PATH, undefined, true)
        .nothrow()
        .stdio("pipe");
  ...
  describe("aetherium core deploy --key ...", () => {
    it("should create a core deployment with the signer as the mailbox owner", async () => {
      const steps: TestPromptAction[] = [
        SELECT_MAINNET_CHAIN_TYPE_STEP,
        {
      ...
      const output = aetheriumCoreDeployRaw(CORE_CONFIG_PATH, ANVIL_KEY).stdio(
        "pipe"
      );
  ...
  describe("AET_KEY= ... aetherium core deploy", () => {
    it("should create a core deployment with the signer as the mailbox owner", async () => {
      const steps: TestPromptAction[] = [
        SELECT_MAINNET_CHAIN_TYPE_STEP,
        {
      ...
      const output = aetheriumCoreDeployRaw(
        CORE_CONFIG_PATH,
        undefined,
        undefined,
        ANVIL_KEY
  ...
  describe("aetherium core deploy --yes --key ...", () => {
    it("should create a core deployment with the signer as the mailbox owner", async () => {
    ...
    it("should create a core deployment with the mailbox owner set to the address in the config", async () => {
      ...
      await aetheriumCoreDeploy(CHAIN_NAME_2, CORE_READ_CONFIG_PATH_2);
