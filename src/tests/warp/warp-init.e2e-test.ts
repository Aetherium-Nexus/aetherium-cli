...
import { aetheriumWarpInit } from "../commands/warp.js";

describe("aetherium warp init e2e tests", async function () {
  ...
  describe("aetherium warp init --yes", () => {
    ...
    it("it should generate a warp deploy config with a single chain", async function () {
      ...
      const output = aetheriumWarpInit(WARP_CONFIG_PATH_2).stdio("pipe");
