...
import { TokenType, WarpRouteDeployConfig } from "@aetherium-nexus/sdk";
...
import {
  aetheriumWarpDeploy,
  aetheriumWarpReadRaw,
  readWarpConfig,
} from "../commands/warp.js";

describe("aetherium warp read e2e tests", async function () {
  ...
  describe("aetherium warp read --config ...", () => {
    it("should exit early if no symbol, chain or warp file have been provided", async () => {
      await aetheriumWarpDeploy(WARP_CONFIG_PATH_2);

      const output = await aetheriumWarpReadRaw({
  ...
  describe("aetherium warp read --config ... --symbol ...", () => {
  ...
  describe("aetherium warp read --symbol ...", () => {
    it("should successfully read the complete warp route config from all the chains", async () => {
      ...
      const output = aetheriumWarpReadRaw({
        symbol: "ETH",
  ...
  describe("aetherium warp read --chain ... --config ...", () => {
