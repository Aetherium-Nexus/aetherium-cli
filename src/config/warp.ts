...
import { Address, assert, objMap, promiseObjAll } from "@aetherium-nexus/utils";
...
export async function createWarpRouteDeployConfig({
  ...
  try {
    ...
    errorRed(
      `Warp route deployment config is invalid, please see https://github.com/Aetherium-Nexus/aetherium-cli/blob/main/examples/warp-route-deployment.yaml for an example.`
    );
    throw e;
  }
}
