...
import { DEFAULT_GITHUB_REGISTRY } from "@aetherium-nexus/registry";
import { LogFormat, LogLevel } from "@aetherium-nexus/utils";

import { ENV } from "../utils/env.js";

/* Global options */

export const DEFAULT_LOCAL_REGISTRY = `${os.homedir()}/.aetherium`;
...
export const disableProxyCommandOption: Options = {
  type: "boolean",
  description:
    "Disable routing of Github API requests through the Aetherium registry proxy.",
  default: false,
};
...
export const DEFAULT_STRATEGY_CONFIG_PATH = `${os.homedir()}/.aetherium/strategies/default-strategy.yaml`;
