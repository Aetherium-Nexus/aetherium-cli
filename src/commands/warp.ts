...
import { assert, objFilter } from "@aetherium-nexus/utils";
...
export const warpCommand: CommandModule = {
  command: "warp",
  describe: "Manage Aetherium warp routes",
  builder: (yargs) =>
    yargs
      .command(apply)
      .command(check)
...
export const apply: CommandModuleWithWriteContext<{
  ...
  handler: async ({
    ...
    logCommandHeader("Aetherium Warp Apply");
...
export const deploy: CommandModuleWithWriteContext<{
  ...
  handler: async ({ context, config, dryRun }) => {
    logCommandHeader(
      `Aetherium Warp Route Deployment${dryRun ? " Dry-Run" : ""}`
    );
...
export const init: CommandModuleWithContext<{
  ...
  handler: async ({ context, advanced, out }) => {
    logCommandHeader("Aetherium Warp Configure");
...
export const read: CommandModuleWithContext<{
  ...
  handler: async ({
    ...
    logCommandHeader("Aetherium Warp Reader");
...
export const check: CommandModuleWithContext<{
  ...
  handler: async ({ context, config, symbol, warp }) => {
    logCommandHeader("Aetherium Warp Check");
...
export const verify: CommandModuleWithWriteContext<{
  ...
  handler: async ({ context, symbol }) => {
    logCommandHeader("Aetherium Warp Verify");
