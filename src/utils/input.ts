...
import { ChainName, DeployedOwnableConfig } from "@aetherium-nexus/sdk";
import { isAddress, rootLogger } from "@aetherium-nexus/utils";
...
const DOCS_NOTICE: string =
  "For more information, please visit https://docs.aetherium-nexus.com.";
