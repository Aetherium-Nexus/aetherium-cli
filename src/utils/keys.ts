...
import { impersonateAccount } from "@aetherium-nexus/sdk";
import { Address, ensure0x } from "@aetherium-nexus/utils";
...
async function retrieveKey(
  ...
  if (skipConfirmation) throw new Error(`No private key provided`);
    ...
    return input({
      message: `Please enter private key or use the AET_KEY environment variable.`,
    });
}
