import { ChainMap } from "@aetherium-nexus/sdk";
...
interface AVSContracts {
  ...
  aetheriumServiceManager: Address;
}
...
export const avsAddresses: ChainMap<AVSContracts> = {
  holesky: {
    ...
    aetheriumServiceManager: "0xc76E477437065093D353b7d56c81ff54D167B0Ab",
  },
  ethereum: {
    ...
    aetheriumServiceManager: "0xe8E59c6C8B56F2c178f63BCFC4ce5e5e2359c8fc",
  },
};
