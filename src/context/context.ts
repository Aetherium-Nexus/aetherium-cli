...
import { IRegistry } from "@aetherium-nexus/registry";
import { getRegistry } from "@aetherium-nexus/registry/fs";
import {
  ChainMap,
  ChainMetadata,
  ChainName,
...
import { isNullish, rootLogger } from "@aetherium-nexus/utils";
...
export async function signerMiddleware(argv: Record<string, any>) {
  ...
  /**
   * Intercepts Aetherium command to determine chains.
   */
