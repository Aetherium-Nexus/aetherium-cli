...
import { toBase64 } from "@aetherium-nexus/utils";
...
const getKurtosisCloudUrl = (base64Params: string) =>
  `https://cloud.kurtosis.com/enclave-manager?package-id=github.com%2Fkurtosis-tech%2Faetherium-package&package-args=${base64Params}`;
